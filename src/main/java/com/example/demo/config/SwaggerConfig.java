...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("Blog rest apis", "spring", "1", "terms of service", new Contact("dragos", "www.eu.com", "dragos@yahoo.com"), "License", "www.license.com", Collections.emptyList());
    }
